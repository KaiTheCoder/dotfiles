...
static const char *colors[][3]      = {
    ...
    [SchemeSel] = {col_pucc_purple, col_pucc_blugray, col_pucc_purple},
    [SchemeOccSel] = {col_pucc_purple, col_pucc_blugray, col_pucc_purple},
    [SchemeOccNorm] = {col_pucc_pink, col_pucc_blugray2, col_pucc_purple},
};
